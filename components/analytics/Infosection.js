      ...
      <>
        <section className=" :bg-block sticky -top-0 z-50 mx-auto h-20 w-[100vw] overflow-hidden md:hidden lg:block lg:bg-amber-800">
          <div className="flex- mx-auto flex w-full items-end justify-around md:flex-row md:items-center md:justify-start md:gap-x-5">
            ...
            <h1 className="w-48 rounded-2xl  border py-1 px-2 font-mono text-xs text-white">
            ...
            <Link href="/rettungsankerChat">
              <a className="fond-black w-40 rounded-2xl border bg-slate-800 text-center text-[1.666rem] text-white shadow-2xl shadow-slate-700 hover:bg-amber-400">
                Blog
              </a>
            </Link>
          </div>
