!(function (e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : (e.ReactCustomScroll = t(e['prop-types'], e.react, e['react-dom']))
    ...
    return (
      (() => {
        ...
        var d = function (e, t, o) {
          return (t = t || 0 === t ? t : e) > (o = o || 0 === o ? o : e)
        ...
        var m = (function (o) {
          ...
          function S(t) {
            ...
            return (
              ...
              h(p(o), 'scrollHandleRef', (0, e.createRef)()),
              h(p(o), 'contentWrapperRef', (0, e.createRef)()),
              h(p(o), 'adjustFreezePosition', function (e) {
                if (o.contentWrapperRef.current) {
                  var t = o.getScrolledElement(),
                    r = o.contentWrapperRef.current
                  o.props.freezePosition && (r.scrollTop = o.state.scrollPos),
                    e.freezePosition && (t.scrollTop = o.state.scrollPos)
                }
              }),
              h(p(o), 'toggleScrollIfNeeded', function () {
                var e = o.contentHeight - o.visibleHeight > 1
                o.hasScroll !== e && ((o.hasScroll = e), o.forceUpdate())
              }),
              h(p(o), 'updateScrollPosition', function (e) {
                var t = o.getScrolledElement(),
                  r = d(e, 0, o.contentHeight - o.visibleHeight)
                ;(t.scrollTop = r), o.setState({ scrollPos: r })
              }),
              h(p(o), 'onClick', function (e) {
                if (
                  o.hasScroll &&
                  o.isMouseEventOnCustomScrollbar(e) &&
                  !o.isMouseEventOnScrollHandle(e)
                ) {
              ...
              h(p(o), 'isMouseEventOnCustomScrollbar', function (e) {
                ...
                var t = r().findDOMNode(p(o)).getBoundingClientRect(),
                  ...
                  l = o.props.rtl
                    ? { left: t.left, right: n.right }
                    : { left: n.left, width: t.right }
                return g(
                  e,
                  Object.assign(
                    {},
                    { left: t.left, right: t.right, top: t.top, height: t.height },
                    l
                  )
                )
              }),
              h(p(o), 'isMouseEventOnScrollHandle', function (e) {
                return (
                  !!o.scrollHandleRef.current &&
                  (function (e, t) {
                    return g(e, t.getBoundingClientRect())
                  })(e, r().findDOMNode(o.scrollHandleRef.current))
                )
              }),
              h(p(o), 'calculateNewScrollHandleTop', function (e) {
                var t = r().findDOMNode(p(o)).getBoundingClientRect().top + window.pageYOffset,
                  n = e.pageY - t,
                  l = o.getScrollHandleStyle().top
                return n > l + o.scrollHandleHeight
                  ? l + Math.min(o.scrollHandleHeight, o.visibleHeight - o.scrollHandleHeight)
                  : l - Math.max(o.scrollHandleHeight, 0)
              }),
              h(p(o), 'getScrollValueFromHandlePosition', function (e) {
                return e / o.scrollRatio
              }),
              h(p(o), 'getScrollHandleStyle', function () {
                var e = o.state.scrollPos * o.scrollRatio
                return (
                  (o.scrollHandleHeight = o.visibleHeight * o.scrollRatio),
                  { height: o.scrollHandleHeight, top: e }
                )
              }),
              h(p(o), 'adjustCustomScrollPosToContentPos', function (e) {
                o.setState({ scrollPos: e })
              }),
              h(p(o), 'onScroll', function (e) {
                o.props.freezePosition ||
                  (o.hideScrollThumb(),
                  o.adjustCustomScrollPosToContentPos(e.currentTarget.scrollTop),
                  o.props.onScroll && o.props.onScroll(e))
              }),
              h(p(o), 'getScrolledElement', function () {
                return o.innerContainerRef.current
              }),
              h(p(o), 'onMouseDown', function (e) {
                o.hasScroll &&
                  o.isMouseEventOnScrollHandle(e) &&
                  ((o.startDragHandlePos = o.getScrollHandleStyle().top),
                  (o.startDragMousePos = e.pageY),
                  o.setState({ onDrag: !0 }),
                  document.addEventListener('mousemove', o.onHandleDrag, { passive: !1 }),
                  document.addEventListener('mouseup', o.onHandleDragEnd, { passive: !1 }))
              }),
              h(p(o), 'onTouchStart', function () {
                o.setState({ onDrag: !0 })
              }),
              h(p(o), 'onHandleDrag', function (e) {
                e.preventDefault()
                var t = e.pageY - o.startDragMousePos,
                  r = d(o.startDragHandlePos + t, 0, o.visibleHeight - o.scrollHandleHeight),
                  n = o.getScrollValueFromHandlePosition(r)
                o.updateScrollPosition(n)
              }),
              h(p(o), 'onHandleDragEnd', function (e) {
                o.setState({ onDrag: !1 }),
                  e.preventDefault(),
                  document.removeEventListener('mousemove', o.onHandleDrag),
                  document.removeEventListener('mouseup', o.onHandleDragEnd)
              }),
              h(p(o), 'blockOuterScroll', function (e) {
                if (!o.props.allowOuterScroll) {
                  ...
                  t.scrollTop + n <= 0
                    ...
                    : t.scrollTop + n >= r && ((t.scrollTop = r), e.preventDefault()),
                    e.stopPropagation()
                }
              }),
              h(p(o), 'getInnerContainerClasses', function () {
                return o.state.scrollPos && o.props.addScrolledClass
                  ? ''.concat(n.innerContainer, ' ').concat(n.contentScrolled)
                  : n.innerContainer
              }),
              h(p(o), 'getScrollStyles', function () {
                var e = o.scrollbarYWidth || 20,
                  t = o.props.rtl ? 'marginLeft' : 'marginRight',
                  r = { height: o.props.heightRelativeToParent || o.props.flex ? '100%' : '' }
                r[t] = -1 * e
                var n = {
                  height: o.props.heightRelativeToParent || o.props.flex ? '100%' : '',
                  overflowY: o.props.freezePosition ? 'hidden' : 'visible',
                }
                return (n[t] = o.scrollbarYWidth ? 0 : e), { innerContainer: r, contentWrapper: n }
              }),
              h(p(o), 'getOuterContainerStyle', function () {
                return { height: o.props.heightRelativeToParent || o.props.flex ? '100%' : '' }
              }),
              h(p(o), 'getRootStyles', function () {
                var e = {}
                return (
                  o.props.heightRelativeToParent
                    ? (e.height = o.props.heightRelativeToParent)
                    : o.props.flex && (e.flex = o.props.flex),
                  e
                )
              }),
              h(p(o), 'enforceMinHandleHeight', function (e) {
                ...
                return { height: t, top: e.top - r }
              }),
              (o.scrollbarYWidth = 0),
              (o.state = { scrollPos: 0, onDrag: !1 }),
            ...
            (i = [
              {
                ...
                value: function () {
                  void 0 !== this.props.scrollTo
                    ...
                    : this.forceUpdate(),
                    this.innerContainerRef.current &&
              ...
              },
              {
                ...
                value: function (e, t) {
                  var o = this.contentHeight,
                    ...
                    l = t.scrollPos >= o - r
                  ;(this.contentHeight = n.scrollHeight),
                    (this.scrollbarYWidth = n.offsetWidth - n.clientWidth),
                    (this.visibleHeight = n.clientHeight),
                  ...
                  ;(this.props.freezePosition || e.freezePosition) && this.adjustFreezePosition(e),
                    void 0 !== this.props.scrollTo && this.props.scrollTo !== e.scrollTo
                      ? this.updateScrollPosition(this.props.scrollTo)
                ...
                value: function () {
                  var e = this.getScrollStyles(),
                    ...
                    l = [
                      ...
                      n.customScroll,
                      this.state.onDrag ? n.scrollHandleDragged : '',
                    ].join(' ')
                        ...
                        ? t().createElement(
                            ...
                            t().createElement(
                              'div',
                              {
                                ...
                                className: ''
                                  .concat(n.customScrollbar, ' ')
                                  .concat(this.props.rtl ? n.customScrollbarRtl : ''),
                                key: 'scrollbar',
                              },
                              t().createElement(
                                'div',
                                ...
                                t().createElement('div', { className: this.props.handleClass })
                              )
                            )
                          )
                        : null,
        ...
        m.defaultProps = { handleClass: n.innerHandle, minScrollHandleHeight: 38 }
        const S = m
      })(),
      i
    )
