...
<hr className="my- border-gray-400" />
  <div className="mt-12 pt-26 border-3 border-l-0 border-r-0 border-white  "> 
      ...
      <div className="container px-4 mx-auto ">
        <div className="flex flex-wrap -mx-4 justify-between">
          <div className="w-full md:w-auto xl:w-1/3 px-4 mb-14 xl:mb-0">
            <a className="inline-block mx-auto mb-12" href="#">
              <img className="h-24" src="/LogoNeu.png" alt=""/>
            </a>
            <div className="flex flex-wrap justify-between items-center -mb-6"><Modale11/><Modale12/><Modale13/><Modale14/><Modale15/><Modale16/></div>
            <h4 className="mt-24 text-2xl font-semibold text-yellow-300">unsere Partner</h4>
            <div className="flex flex-col lg:flex lg:flex-row lg:justify-around">
            <div className="w-/12 px-4 flex flex-row lg:items-center gap-x-10 ">
             
               <div className=" h-10 w-10 lg:h-24 lg:w-24">
                  <Image
                    src="/Astra.svg"
                    width="5vw"
                    height="5vh"
                ...
                <div className=" transform translate-y-3 h-16 w-16 lg:w-32 lg:h-32">
                  <Image
                ...
                <div className=" transform translate-y-4 h-12 w-12 lg:h-16 lg:w-16">
                  <Image
                    src="/Flens-logo.svg"
                    width="5vw"
                    height="5vh"
          ...
          <div className="w-full md:w-auto xl:w-1/3 px-4">
    ...
    <div className="container px-4 pt-16 pb-20 mx-auto bg-no-repeat sm:bg-[length:100%,50%] sm:py-4 lg:w-full lg:bg-slate-900 ">
      ...
      <div className="flex flex-row justify-between">
            ...
            <div className="mx-auto w-full px-4 text-center md:w-8/12">
              <div className="py-1 text-sm font-semibold text-gray-400 lg:text-[0.77rem]">
                ...
                <Skyline className="-mt-12 mx-auto w-48 h-48 opacity-75"/>
              </div>
            </div>
          </div>
